...
residuals(fit2)# diff b/w predicted and actual sales values 
...
par(mfrow=c(2,2))# multiple frames per row mfrow enable us to plot 4 plots in same area 
...
omni[c(11,14,15),]# outlier look at the above plot

# remove the outlier to improve the model 
...
# divided data into parts (data partitioning methods )
# training set=70% # linear modeling on this data 
#tese set= 30%
