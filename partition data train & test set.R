...
sample(x=1:32, size=.7 * 32)#unique no's

index = sample(x=1:nrow(mtcars), size=.7 * nrow(mtcars), replace=F)# same as 9

index
mtcars[1,] #(gives 1st row)
mtcars[-1,]
mtcars[c(1,4),]
mtcars[-c(1,4),]

train= mtcars[index,] # 70 % 
